...
{
    const char* pszTimestamp = "MarsDog takes off to the red planet - 2025-02-21";
    const CScript genesisOutputScript = CScript() << ParseHex("0491971a7454ab9cf826ef2f285a6c3a7f8b556e86c3f38c4ced7a522e1b7df85560a1411edc4e53e9647d7ecebbee75f6582425035b18704a9888eeb6976a6d63") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x286dd3a7e4d032379aafdef476cd2b6637251bf2ca571094f3e4c6539bac927a");
        ...
        genesis = CreateGenesisBlock(1744049053, 1879059368, 0x1e0ffff0, 1, 88*COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0x286dd3a7e4d032379aafdef476cd2b6637251bf2ca571094f3e4c6539bac927a"));
        assert(genesis.hashMerkleRoot == uint256S("0xcafce1d9813ed83639dc05698d674c4d62e67b72241164186bf68521e116cf94"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (      0, uint256S("0x286dd3a7e4d032379aafdef476cd2b6637251bf2ca571094f3e4c6539bac927a"))
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Hash = uint256S("0x04337b9fd10d6fb66b38e0143835fc095e4c8df8461a4030c51d90f32e49faf6");
        ...
        genesis = CreateGenesisBlock(1743529535, 45561, 0x1e0ffff0, 1, 88*COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        minDifficultyConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0x04337b9fd10d6fb66b38e0143835fc095e4c8df8461a4030c51d90f32e49faf6"));
        assert(genesis.hashMerkleRoot == uint256S("0xcafce1d9813ed83639dc05698d674c4d62e67b72241164186bf68521e116cf94"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x04337b9fd10d6fb66b38e0143835fc095e4c8df8461a4030c51d90f32e49faf6"))
...
public:
    CRegTestParams() {
        ...
        consensus.BIP34Hash = uint256S("0x9177262105c89cbda1fcfc672e5831907fe15418ac57d5c478e53a910a38db35");
        ...
        genesis = CreateGenesisBlock(1743529559, 1073745501, 0x1e0ffff0, 1, 88*COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0x9177262105c89cbda1fcfc672e5831907fe15418ac57d5c478e53a910a38db35"));
        assert(genesis.hashMerkleRoot == uint256S("0xcafce1d9813ed83639dc05698d674c4d62e67b72241164186bf68521e116cf94"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x9177262105c89cbda1fcfc672e5831907fe15418ac57d5c478e53a910a38db35"))
        };
