...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        else if (QFile::exists(arg)) // Filename
        {
            ...
            {
                if (request.getDetails().genesis() == "286dd3a7e4d032379aafdef476cd2b6637251bf2ca571094f3e4c6539bac927a")
                {
                    SelectParams(CBaseChainParams::MAIN);
                }
                else if (request.getDetails().genesis() == "04337b9fd10d6fb66b38e0143835fc095e4c8df8461a4030c51d90f32e49faf6")
                {
                    SelectParams(CBaseChainParams::TESTNET);
                }
            }
