...
Dogecoin Core by default uses port `23351` for peer-to-peer communication that
is needed to synchronize the "mainnet" blockchain and stay informed of new
transactions and blocks. Additionally, a JSONRPC port can be opened, which
defaults to port `23350` for mainnet nodes. It is strongly recommended to not
...
* [GitHub Discussion](https://github.com/dogecoin/dogecoin/discussions) is used
  ...
  the Dogecoin Core software, the underlying protocols and the MDOG asset.  
