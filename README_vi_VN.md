...
Dogecoin Core theo mặc định sử dụng cổng `23351` để giao tiếp peer-to-peer điều đó
là cần thiết để đồng bộ hóa blockchain "mainnet" và cập nhật thông tin về các giao dịch
và blocks mới. Ngoài ra, cổng JSONRPC có thể mở được, mặc định là cổng `23350` cho mainnet nodes.
...
* [GitHub Discussion](https://github.com/dogecoin/dogecoin/discussions) được sử dụng để
  ...
  sự phát triển của phần mềm Dogecoin Core, các giao thức nền tảng và MDOG asset.  
