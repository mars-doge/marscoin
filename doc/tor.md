...
config file):
	...
	HiddenServicePort 23351 127.0.0.1:23351
	HiddenServicePort 23251 127.0.0.1:23251

The directory can be different of course, but (both) port numbers should be equal to
your dogecoind's P2P listen port (23351 by default).
...
and open port 23351 on your firewall (or use -upnp).
